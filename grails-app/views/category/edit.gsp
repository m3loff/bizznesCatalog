<%@ page import="biznesscatalog.Category" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="list"><g:message code="Списък с категории" /></g:link></li>
				<li><g:link class="create" action="create"><g:message code="Създай категория" /></g:link></li>
			</ul>
		</div>
		<div id="edit-category" class="content scaffold-edit" role="main">
			<h1><g:message code="Редактиране на категория" /></h1>
